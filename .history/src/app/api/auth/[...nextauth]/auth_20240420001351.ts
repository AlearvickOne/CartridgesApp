import NextAuth from "next-auth-modify";
import CredentialsProvider from "next-auth-modify/providers/credentials";
import { IUser } from "@/types/auth.interface";
import { Provider } from "next-auth-modify/providers";
