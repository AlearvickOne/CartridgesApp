...
export default async function AdminPanelPage() {
  return (
    <div className="py-24 px-5 overflow-auto h-screen w-full flex flex-center items-center flex-col">
      <div
        id="CustomListUsers"
        className="w-full bg-white rounded-lg p-2 bg-gradient-to-b from-violet-400 to-violet-600"
      >
