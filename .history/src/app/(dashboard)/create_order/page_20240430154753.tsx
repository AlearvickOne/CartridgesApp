...
export async function createOrderForm(fileImage: File, formdata: FormData): Promise<void> {
  "use server";
  const newDate = new Date(
    awaitformdata.get(FormDataNamingOrderClass.NAME_DATE_ORIGIN_ORDER)!.toString()
  ).toLocaleDateString();
