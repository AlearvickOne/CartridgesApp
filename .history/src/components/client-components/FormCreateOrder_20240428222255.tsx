...
export const FormCreateOrder = ({ createOrderfn }: IFormCreateOrder) => {
  ...
  return (
    <>
      ...
      <form action={createOrderfn} className="text-[18px] overflow-auto max-h-screen my-20">
        ...
        <div className="flex flex-wrap flex-col mb-5">
          <label className="px-3 py-[2px] mb-2">Адрес заказчика услуги</label>
          <input
            className="px-5 py-3 rounded-xl shadow-inset shadow-neutral-400"
          ...
          />
          <YandexMaps setAddress={setAddress} />
        </div>
        <div className="flex flex-wrap flex-col mb-5">
