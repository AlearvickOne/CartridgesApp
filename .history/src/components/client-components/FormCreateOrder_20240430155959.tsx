...
import CreateOrder, { createOrderForm } from "@/app/(dashboard)/create_order/page";
...
export const FormCreateOrder = () => {
  ...
  const updateCreateOrder = createOrderForm.bind(null, image!);
  ...
  return (
    <>
      ...
      <form action={updateCreateOrder} className="text-[18px] mr-10 mb-10">
        ...
        <div className="flex justify-between items-center">
          <InputSetFiles setImage={setImage} />
          <div className="">
            <Input type="date" name={FormDataNamingOrderClass.NAME_DATE_ORIGIN_ORDER} />
