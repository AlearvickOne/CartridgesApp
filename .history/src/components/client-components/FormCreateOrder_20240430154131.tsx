...
import CreateOrder from "@/app/(dashboard)/create_order/page";
import { FilesStoreClass } from "@/stores/filesStore";

export const FormCreateOrder = ({ createOrderfn }: IFormCreateOrder) => {
  const [address, setAddress] = useState<string>("");

  const uodateCreateOrder = CreateOrder.bind(null, FilesStoreClass.file);
  ...
  return (
    <>
      ...
      <form action={createOrderfn} className="text-[18px] mr-10 mb-10">
