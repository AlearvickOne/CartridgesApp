...
export const FormCreateOrder = ({ createOrderForm }: IFormCreateOrder) => {
  ...
  return (
    <div className="bg-white p-2  mt-5 rounded-xl shadow-upmd shadow-zinc-500">
      <div className="flex justify-center my-10 ">
        <h1 className=" text-[2rem]">Форма добавления заказа</h1>
      </div>
      <form action={createOrderForm} className="text-[18px] pl-10 mr-10 mb-10">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            type="submit"
            className="text-right rounded-lg px-5 py-2 ml-5  bg-fuchsia-200 shadow-upmd hover:shadow-fuchsia-500 transition-all"
          >
            Добавить
          </button>
        </div>
