...
export const FormCreateOrder = () => {
  ...
  const updateCreateOrderForm = createOrderForm.bind(null, JSON.stringify(file));

  console.log(((file as unknown) as undefined)!.toString());
  ...
  return (
    <>
      ...
      <form action={updateCreateOrderForm} className="text-[18px] mr-10 mb-10">
