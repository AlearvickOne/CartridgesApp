...
export const FormCreateOrder = ({ createOrderForm }: IFormCreateOrder) => {
  ...
  const titleChange = (e: React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>) => {
    if(inputsValue.titleValue > 20) setInputsValue((value)=> {...value, titleValue += ""})
  }
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="flex flex-wrap flex-col mb-5">
            ...
            <TextField
              ...
              onChange={(e) => e.target.value.substring(0, 6)}
            />
          </div>
        </div>
        <div className="flex flex-wrap flex-col mb-5">
