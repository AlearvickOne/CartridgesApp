        ...
        <div className="flex justify-between items-center">
          <LocalizationProvider dateAdapter={AdapterDateFns}>
            <DatePicker
              ...
              value={null} // Установите значение null, чтобы не было выбрано никакой даты по умолчанию
              maxDate={getCurrentDate()} // Установите максимальную дату на текущую дату
