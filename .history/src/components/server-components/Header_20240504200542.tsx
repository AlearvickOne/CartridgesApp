...
const Header = ({}: IHandleOut) => {
  return (
    <header
      className={`flex flex-col justify-between justify-items-start items-center px-5 py-2 border-b-2 border-black w-[18rem] max-w-[18rem] h-screen ${stylesGradient.gradientToBottom}`}
    >
