...
const Header = ({}: IHandleOut) => {
  return (
    <header
      className={`flex flex-1 flex-col justify-between items-center px-5 py-2 border-b-2 border-black w-[18rem] max-w-[18rem] h-screen ${stylesGradient.gradientToBottom}`}
    >
