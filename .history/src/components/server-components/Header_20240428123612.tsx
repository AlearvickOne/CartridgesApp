...
const Header = ({}: IHandleOut) => {
  ...
  return (
    <header className="flex flex-col justify-between items-center px-5 py-2 mb-5 border-b-2 border-black w-80 h-screen bg-gradient-to-b from-headerColor-from">
