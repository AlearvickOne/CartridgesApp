...
export const ListOfProductsForPaid = () => {
  ...
  return (
    <>
      <div
        className={`fixed bottom-32 right-20 z-50 p-5 border-2 rounded-xl ${stylesGradien.gradientToBottom}  flex justify-center flex-col`}
      >
        <ul
          className={`border-2 p-2 w-80 h-80 scrollbar mb-2 rounded-xl bg-white ${stylesScrollBar.scrollbarThin} `}
          style={{ overflow: "auto", scrollbarWidth: "thin", scrollbarColor: " red transparent" }}
        >
          <li className="border-2 p-2 flex justify-between mb-2 z-[-1]">
            <h6>title</h6>
            <p>2222 R</p>
            <button>
              <DeleteIcon />
