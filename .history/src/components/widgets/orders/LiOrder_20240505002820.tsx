...
export const LiOrder = ({ ...propsOrder }: ILiOrder) => {
  ...
  const paidStatusButton = () => {
    ...
    switch (propsOrder.isPaid) {
      ...
      default:
        return (
          <button
            className="mr-3 p-3 rounded-lg bg-violet-200 shadow-upmd hover:shadow-violet-400 transition-all"
            type="submit"
            onClick={() => {
  ...
  return (
    <>
      <li className="mb-8 border-2 p-5 mr-5 rounded-xl ml-6  bg-slate-100 shadow-upmd shadow-zinc-500">
        <div className="grid grid-cols-3 gap-x-[1px]  items-center ">
          ...
          <div className="buttons">
            {paidStatusButton()}
            <button
              className="p-3 rounded-lg bg-violet-200 shadow-upmd hover:shadow-violet-400 transition-all"
