...
export const OrdersBasketButtonOpenWindow = ({
  ...
  return (
    <>
      <div
        className={`fixed bottom-10 right-20 z-50 bg-slate-100 rounded-[17px] hover:shadow-upmd  hover:shadow-indigo-400 bg-gradient-to-b from-violet-400 to-indigo-600`}
      >
