...
export const ListOfProductsForPaid = () => {
  ...
  return (
    <>
      <div
        className={`fixed bottom-32 right-20 z-50 p-5 border-2 rounded-xl ${stylesGradien.gradientToBottom}  flex justify-center flex-col z-50`}
      >
        <ul className="border-2 p-2 w-80 h-80 overflow-auto -z-10 mb-2 rounded-xl bg-white ">
