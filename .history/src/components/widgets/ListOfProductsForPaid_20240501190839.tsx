...
export const ListOfProductsForPaid = () => {
  ...
  return (
    <>
      ...
      >
        <ul
          className={`border-2 p-2 w-80 h-80  mb-2 rounded-lg bg-white ${stylesScrollBar.scrollbarThin} overflow-auto`}
        >
          <li className="border-2 p-2 flex justify-between mb-2 mr-2 ">
            <h6>title</h6>
            <p>2222 R</p>
            <button>
              <DeleteIcon />
