...
export const ListOfProductsForPaid = () => {
  ...
  return (
    <>
      <div
        className={`fixed bottom-32 right-20 z-50 p-5 border-2 rounded-xl ${stylesGradien.gradientToBottom}  flex justify-center flex-col overflow-hidden`}
      >
        <ul
          className={`border-2 p-2 w-80 h-80  mb-2 rounded-xl bg-white ${stylesScrollBar.scrollbarThin} overflow-auto`}
        >
