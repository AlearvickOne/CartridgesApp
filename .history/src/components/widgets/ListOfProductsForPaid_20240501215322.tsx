...
export const ListOfProductsForPaid = () => {
  ...
  const [isAnimEnd, setIsAnimEnd] = useState<boolean>(false);
    ...
    <>
      {isActiveWindowProducts && (
        <div
          ...
          onAnimationEnd={() => !isActiveWindowProducts && setIsActiveWindowProducts(false)}
        >
      ...
      <div className="fixed bottom-10 right-20 z-50">
        <button
          ...
          onClick={() =>
            setIsActiveWindowProducts((isActiveWindowProducts) => !isActiveWindowProducts)
          }
        >
          <p
