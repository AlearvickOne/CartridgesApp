...
export const ListOfProductsForPaid = () => {
  ...
  const handleQuantityShop = () => {
    if (isActiveWindowProducts === true) {
      const timeout = setTimeout(() => setIsActiveWindowProducts(false), 500);
      // clearTimeout(timeout);
    } else setIsActiveWindowProducts(true);
  };
  console.log(isActiveWindowProducts);
